  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-center gap-6 text-grey1 font-neuemon text-base font-medium md:para18 items-start border-b pb-2 border-line">
          <p className=" w-[370px] tracking-[-2%]"></p>
          <p className=" w-[370px] tracking-[-2%]">WUTONG</p>
...
const ChioceTable = ({ question, wutong, other }) => {
  return (
    <div className="flex justify-center gap-6 text-sm font-monasan font-medium md:para items-start border-b pb-2 border-line">
      <p className="text-green w-[370px] tracking-[-2%]">{question}</p>
      <p className="text-grey w-[370px] tracking-[-2%]">{wutong}</p>
      <p className="text-grey w-[370px] tracking-[-2%]">{other}</p>
    </div>
  );
};
